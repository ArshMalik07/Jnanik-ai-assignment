...
A step-by-step guide: Defining an LLM agent 
Govern and scale your agent taskforce with  Gemini Enterprise 
...
![page2_img0.png](./figures/page2_img0.png)

![page2_img1.png](./figures/page2_img1.png)
...
![page3_img0.png](./figures/page3_img0.png)
...
![page4_img0.png](./figures/page4_img0.png)
...
![page5_img0.png](./figures/page5_img0.png)

![page5_img1.png](./figures/page5_img1.png)
...
Build your  own agents Use  Google Cloud agents Bring in  partner agents 
...
![page6_img0.png](./figures/page6_img0.png)

![page6_img1.png](./figures/page6_img1.png)

![page6_img2.png](./figures/page6_img2.png)

![page6_img3.png](./figures/page6_img3.png)
...
Section 2 Section 3 Section 1: Core concepts of AI agents 
...
![page7_img0.png](./figures/page7_img0.png)
...
6 
Section 1: Core concepts of AI agents 
Gemini Enterprise for   application-first development 
The second primary pathway for building is through   Gemini Enterprise . Unlike the code-first ADK, you can use  Gemini Enterprise to orchestrate your entire AI taskforce  and empower non-technical team members to build custom  agents using a no-code designer. 
...
•	  No-code custom agent builder:  Includes Agent Designer,  which allows non-technical users to create agents   via a prompt-driven interface, creating their own   “AI helpers” without writing code. 
Why it matters for startups 
...
![page8_img0.png](./figures/page8_img0.png)
...
![page9_img0.png](./figures/page9_img0.png)
...
![page10_img0.png](./figures/page10_img0.png)
...
![page12_img0.png](./figures/page12_img0.png)
...
![page13_img0.png](./figures/page13_img0.png)
...
Vertex AI Search A managed service for building high-performance   vector search applications. It is the primary tool for  enabling semantic understanding and retrieval over   large, unstructured datasets. 
Instantly find answers within your internal product  documentation, customer support chat logs, and  community forum posts, so your agent can provide  accurate, context-aware support to new users.   This reduces the burden on your small support team. 
Firestore A serverless NoSQL document database with real-time  synchronization capabilities. Its flexible, hierarchical data  model is well-suited for storing structured context and  the dynamic state of an agent’s long-running or durable  state active tasks. 
Maintain the real-time state of a multi-step, agentguided user onboarding flow. As the user completes  each step (e.g., “create profile,” “connect API,” “invite  team member”), the agent updates a Firestore  document. Developers can then observe the agent’s  task progress in real-time, and the user can seamlessly  resume the process across sessions. 
...
Instead of manually building logic to extract user  preferences, an agent can automatically call  GenerateMemories  on a conversation history.   This asynchronously extracts key facts (e.g., “user  prefers non-stop flights,” “user’s dog is named Fido”)   and stores them. In future sessions, the agent can  retrieve these memories via similarity search to provide  a deeply personalized and continuous experience with  minimal custom code. 
Cloud Storage A highly scalable and durable object store for raw,  unstructured source data (e.g., PDFs, images, videos)   that feeds into other services for indexing and processing. 
It serves as the durable, low-cost landing zone for all  user-uploaded documents, images of bug reports,   or audio recordings of customer feedback calls. This   raw data is then processed and indexed by services  like Vertex AI Search to enrich your agent’s knowledge. 
BigQuery A fully-managed, serverless data warehouse for storing  and analyzing massive structured and semi-structured  datasets, so agents can be equipped with tools that  execute complex analytical queries. 
...
Data service Overview Startup use cases 
Cloud SQL A fully managed service for traditional relational  databases that provides strong consistency for singleregion transactional workloads. It is the standard choice  for reliable state management. 
...
Cloud Spanner A globally distributed, strongly consistent relational  database offering horizontal scalability. It is designed for  mission-critical applications that require high availability  and transactional integrity across geographic regions. 
A startup would typically migrate from Cloud SQL to  Spanner only after achieving product-market fit where  its user base becomes globally distributed. For example,  a travel or ecommerce app that initially used Cloud SQL  now needs to process bookings or orders from users   in North America, Europe, and Asia simultaneously  without data conflicts. Spanner’s global transactional  consistency supports this scale. 
Data service Overview Startup use cases 
Memorystore A fully managed, in-memory data store providing   sub-millisecond latency. It is ideal for caching frequently  accessed data and managing session state. 
Its primary role is high-speed caching to store the  results of any computationally expensive or high-latency  operation. Instead of repeatedly executing a costly task  such as an LLM API call, a complex database query,   or a call to a third-party service, the agent first checks  Memorystore for a cached result. It drastically reduces  both response latency and recurring operational costs,  both critical to a startup’s agentic system. 
...
![page16_img0.png](./figures/page16_img0.png)
...
![page17_img0.png](./figures/page17_img0.png)
...
![page18_img0.png](./figures/page18_img0.png)
...
Use case 
Use the check grounding API to verify whether the   AI’s answers are based on grounded, up-to-date info. Use Vertex AI Search and Vertex AI RAG Engine   to ground responses using your proprietary content. 
Tool Pro tip 

![page20_img0.png](./figures/page20_img0.png)
...
Cloud Spanner 
Data files 
Monitoring IAM Logging 
Gemini API   Vertex AI Vertex AI Agent Engine File processor Cloud Run File queue   Pub/Sub 
Use case 

![page21_img0.png](./figures/page21_img0.png)

![page21_img1.png](./figures/page21_img1.png)

![page21_img2.png](./figures/page21_img2.png)

![page21_img3.png](./figures/page21_img3.png)

![page21_img4.png](./figures/page21_img4.png)

![page21_img5.png](./figures/page21_img5.png)

![page21_img6.png](./figures/page21_img6.png)

![page21_img7.png](./figures/page21_img7.png)

![page21_img8.png](./figures/page21_img8.png)

![page21_img9.png](./figures/page21_img9.png)

![page21_img10.png](./figures/page21_img10.png)

![page21_img11.png](./figures/page21_img11.png)

![page21_img12.png](./figures/page21_img12.png)

![page21_img13.png](./figures/page21_img13.png)

![page21_img14.png](./figures/page21_img14.png)

![page21_img15.png](./figures/page21_img15.png)

![page21_img16.png](./figures/page21_img16.png)

![page21_img17.png](./figures/page21_img17.png)

![page21_img18.png](./figures/page21_img18.png)

![page21_img19.png](./figures/page21_img19.png)
...
![page22_img0.png](./figures/page22_img0.png)
...
![page23_img0.png](./figures/page23_img0.png)

![page23_img1.png](./figures/page23_img1.png)

![page23_img2.png](./figures/page23_img2.png)

![page23_img3.png](./figures/page23_img3.png)

![page23_img4.png](./figures/page23_img4.png)
...
22 
Section 1: Core concepts of AI agents 
User Gemini Google Search tool 
...
Who won the Euro 2024? Decides to search or not 
Query generation:  [“UEFA Euro 2024 winner”,  “who won euro 2024”] 
Searches the web 
...
![page24_img0.png](./figures/page24_img0.png)

![page24_img1.png](./figures/page24_img1.png)

![page24_img2.png](./figures/page24_img2.png)

![page24_img3.png](./figures/page24_img3.png)

![page24_img4.png](./figures/page24_img4.png)

![page24_img5.png](./figures/page24_img5.png)

![page24_img6.png](./figures/page24_img6.png)

![page24_img7.png](./figures/page24_img7.png)

![page24_img8.png](./figures/page24_img8.png)

![page24_img9.png](./figures/page24_img9.png)

![page24_img10.png](./figures/page24_img10.png)

![page24_img11.png](./figures/page24_img11.png)

![page24_img12.png](./figures/page24_img12.png)
...
![page25_img0.png](./figures/page25_img0.png)
...
![page26_img0.png](./figures/page26_img0.png)
...
![page27_img0.png](./figures/page27_img0.png)
...
Section 1 Section 3 Section 2: How to build AI agents 
...
![page28_img0.png](./figures/page28_img0.png)

![page28_img1.png](./figures/page28_img1.png)
...
![page29_img0.png](./figures/page29_img0.png)

![page29_img1.png](./figures/page29_img1.png)

![page29_img2.png](./figures/page29_img2.png)

![page29_img3.png](./figures/page29_img3.png)

![page29_img4.png](./figures/page29_img4.png)

![page29_img5.png](./figures/page29_img5.png)

![page29_img6.png](./figures/page29_img6.png)

![page29_img7.png](./figures/page29_img7.png)

![page29_img8.png](./figures/page29_img8.png)
...
Agent  User prompts agent 
1 
Model interprets tool B’s  output, generates the agents  response to the user 
Model Model selects Tool B and  formats tool request body {}  (“function-calling”) 
Tools 
Agent framework  calls tool B {} A B C 
4 
2 
3 
...
![page30_img0.png](./figures/page30_img0.png)

![page30_img1.png](./figures/page30_img1.png)

![page30_img2.png](./figures/page30_img2.png)

![page30_img3.png](./figures/page30_img3.png)

![page30_img4.png](./figures/page30_img4.png)

![page30_img5.png](./figures/page30_img5.png)

![page30_img6.png](./figures/page30_img6.png)

![page30_img7.png](./figures/page30_img7.png)

![page30_img8.png](./figures/page30_img8.png)

![page30_img9.png](./figures/page30_img9.png)

![page30_img10.png](./figures/page30_img10.png)

![page30_img11.png](./figures/page30_img11.png)

![page30_img12.png](./figures/page30_img12.png)

![page30_img13.png](./figures/page30_img13.png)
...
LlmAgent (Reasoning,  tools, transfer) CustomAgent SequentialAgent ParallelAgent LoopAgent 
Workflow agents 2 Custom logic 3 
...
![page31_img0.png](./figures/page31_img0.png)

![page31_img1.png](./figures/page31_img1.png)

![page31_img2.png](./figures/page31_img2.png)

![page31_img3.png](./figures/page31_img3.png)

![page31_img4.png](./figures/page31_img4.png)

![page31_img5.png](./figures/page31_img5.png)

![page31_img6.png](./figures/page31_img6.png)

![page31_img7.png](./figures/page31_img7.png)
...
![page32_img0.png](./figures/page32_img0.png)

![page32_img1.png](./figures/page32_img1.png)

![page32_img2.png](./figures/page32_img2.png)
...
![page33_img0.png](./figures/page33_img0.png)

![page33_img1.png](./figures/page33_img1.png)

![page33_img2.png](./figures/page33_img2.png)

![page33_img3.png](./figures/page33_img3.png)

![page33_img4.png](./figures/page33_img4.png)

![page33_img5.png](./figures/page33_img5.png)

![page33_img6.png](./figures/page33_img6.png)
...
•	  Third-party interoperability:  Wrappers like 
LangchainTool  and  CrewaiTool  allow for the direct  reuse of tools from popular open-source ecosystems. 
Pro tip 
33 

![page35_img0.png](./figures/page35_img0.png)
...
![page36_img0.png](./figures/page36_img0.png)

![page36_img1.png](./figures/page36_img1.png)

![page36_img2.png](./figures/page36_img2.png)

![page36_img3.png](./figures/page36_img3.png)

![page36_img4.png](./figures/page36_img4.png)

![page36_img5.png](./figures/page36_img5.png)

![page36_img6.png](./figures/page36_img6.png)

![page36_img7.png](./figures/page36_img7.png)

![page36_img8.png](./figures/page36_img8.png)

![page36_img9.png](./figures/page36_img9.png)

![page36_img10.png](./figures/page36_img10.png)

![page36_img11.png](./figures/page36_img11.png)

![page36_img12.png](./figures/page36_img12.png)

![page36_img13.png](./figures/page36_img13.png)

![page36_img14.png](./figures/page36_img14.png)

![page36_img15.png](./figures/page36_img15.png)

![page36_img16.png](./figures/page36_img16.png)

![page36_img17.png](./figures/page36_img17.png)
...
Deploy to Deploy to Run to 
Package 
![page40_img133.png](./figures/page40_img133.png)

![page40_img134.png](./figures/page40_img134.png)

![page40_img135.png](./figures/page40_img135.png)

![page40_img136.png](./figures/page40_img136.png)

![page40_img137.png](./figures/page40_img137.png)

![page40_img138.png](./figures/page40_img138.png)

![page40_img139.png](./figures/page40_img139.png)
...
ADK agents can natively participate in this ecosystem.   They expose a standard HTTP endpoint and an  agent.json   file, allowing them to be discovered and to communicate  with any other A2A-compliant agent. Explore these A2A resources to get started: 
...
![page41_img0.png](./figures/page41_img0.png)
...
•	  Inject dynamic data  from the agent’s state using 
{variable}  syntax. 
...
Software bug agent  (ADK Python)  Cloud Run 
Google Search tool Agent-as-a-Tool 
GitHub MCP Server MCP Tools 
StackExchange tool LangChain Tool 
MCP Toolbox  for Databases Cloud Run 
Bug ticket database Cloud SQL  PostgreSQL 
IT support 
Pro tip 
Pro tip 
41 

![page43_img0.png](./figures/page43_img0.png)

![page43_img1.png](./figures/page43_img1.png)

![page43_img2.png](./figures/page43_img2.png)

![page43_img3.png](./figures/page43_img3.png)

![page43_img4.png](./figures/page43_img4.png)

![page43_img5.png](./figures/page43_img5.png)

![page43_img6.png](./figures/page43_img6.png)

![page43_img7.png](./figures/page43_img7.png)

![page43_img8.png](./figures/page43_img8.png)

![page43_img9.png](./figures/page43_img9.png)

![page43_img10.png](./figures/page43_img10.png)

![page43_img11.png](./figures/page43_img11.png)
...
![page44_img0.png](./figures/page44_img0.png)
...
Gemini Enterprise  solves these scaling problems. This single,  secure platform allows you to create, govern, and orchestrate  your entire AI agent workforce, unifying disparate applications  and data sources. It complements ADK’s code-first development  by providing the framework to scale agent usage across your  entire organization and manage them effectively. 
You can use Gemini Enterprise to: 
•	  Unify and access company data:  Gemini Enterprise  breaks down data silos by using out-of-the-box   connectors to your existing company applications   (e.g., Microsoft Sharepoint, Google Workspace, Jira).   It applies Google’s multimodal search technology across  this connected data, allowing any employee to get instant  answers and synthesize insights from a central source   of truth while respecting all existing access controls. 
•	  Enable team-wide automation:  While ADK is ideal for  complex, code-first agent development, Gemini Enterprise  empowers your entire organization to automate workflows.  Domain experts in product, marketing, or operations can  use the no-code Agent Designer to build their own custom  agents using a prompt-driven interface. This turns their  specific knowledge into automated solutions without  requiring engineering resources. 
•	  Govern and orchestrate a fleet of agents:  Gemini  Enterprise provides a single platform to manage   and govern agents built with ADK, the no-code designer,   or from partners. The  Agent Gallery  acts as a central   portal for your team to discover, manage, and deploy   them all, including both your custom-built solutions   and pre-built Google Agents designed for complex   tasks like deep research or idea generation. 
Try these prompts in Gemini Enterprise: 
...
![page45_img0.png](./figures/page45_img0.png)
...
Section 1 Section 3 Section 2: How to build AI agents 
How Zoom’s AI agent automatically schedules  meetings from gmail using Google Agentspace   [now Gemini Enterprise] 
...
Solution 
Zoom AI Companion is integrating with Gemini Enterprise   to streamline meeting scheduling. Launching later   this summer, this collaboration will allow A2A-enabled   AI agents to automatically schedule Zoom Meetings  from Gmail context, update Google Calendar, and keep  participants informed, eliminating the back-and-forth   of manual scheduling. 
Impact 
...
![page46_img0.png](./figures/page46_img0.png)

![page46_img1.png](./figures/page46_img1.png)
...
•	  Deploy:  Publish to Firebase App Hosting with a few clicks,  or deploy production apps to Cloud Run, Firebase Hosting,  or your own custom infrastructure. Check out Gemini CLI configured for ADK development. 
...
![page48_img0.png](./figures/page48_img0.png)
...
![page49_img0.png](./figures/page49_img0.png)
...
![page50_img0.png](./figures/page50_img0.png)
...
![page51_img0.png](./figures/page51_img0.png)

![page51_img1.png](./figures/page51_img1.png)
...
OR 
LLM orchestration 
Serving Vertex AI Agent  Engine 
Evaluation 
Evaluation Vertex AI  evaluation 
LLMs 
LLMs Vertex AI  Model Garden 
Data 
Vector store Adapt to any  store 
Data storage  and analysis BigQuery 
Monitoring Looker Studio 
Observability 
Observability Cloud Trace and  OpenTelemetry 
Logging Cloud Logging 
IaC and CI/CD 
CI/CD Cloud build 
Infrastructure  as code Terraform 
Agent orchestration Choose your framework, includes samples  using Google ADK, LangGraph, CrewAI 
Serving Cloud Run 
API server FastAPI 
FrontEnd 
User 
...
•	  CI/CD pipelines (Cloud Build):  A pre-configured 
cloudbuild.yaml  file automates the build, unit testing,  quantitative evaluation, and deployment process,   directly implementing the AgentOps CI/CD workflow. 
...
![page54_img0.png](./figures/page54_img0.png)

![page54_img1.png](./figures/page54_img1.png)

![page54_img2.png](./figures/page54_img2.png)

![page54_img3.png](./figures/page54_img3.png)

![page54_img4.png](./figures/page54_img4.png)

![page54_img5.png](./figures/page54_img5.png)

![page54_img6.png](./figures/page54_img6.png)

![page54_img7.png](./figures/page54_img7.png)

![page54_img8.png](./figures/page54_img8.png)

![page54_img9.png](./figures/page54_img9.png)

![page54_img10.png](./figures/page54_img10.png)

![page54_img11.png](./figures/page54_img11.png)

![page54_img12.png](./figures/page54_img12.png)

![page54_img13.png](./figures/page54_img13.png)

![page54_img14.png](./figures/page54_img14.png)

![page54_img15.png](./figures/page54_img15.png)

![page54_img16.png](./figures/page54_img16.png)

![page54_img17.png](./figures/page54_img17.png)

![page54_img18.png](./figures/page54_img18.png)

![page54_img19.png](./figures/page54_img19.png)

![page54_img20.png](./figures/page54_img20.png)

![page54_img21.png](./figures/page54_img21.png)

![page54_img22.png](./figures/page54_img22.png)

![page54_img23.png](./figures/page54_img23.png)

![page54_img24.png](./figures/page54_img24.png)

![page54_img25.png](./figures/page54_img25.png)

![page54_img26.png](./figures/page54_img26.png)

![page54_img27.png](./figures/page54_img27.png)
...
![page55_img0.png](./figures/page55_img0.png)
...
![page56_img0.png](./figures/page56_img0.png)

![page56_img1.png](./figures/page56_img1.png)

![page56_img2.png](./figures/page56_img2.png)

![page56_img3.png](./figures/page56_img3.png)

![page56_img4.png](./figures/page56_img4.png)

![page56_img5.png](./figures/page56_img5.png)

![page56_img6.png](./figures/page56_img6.png)
...
![page57_img0.png](./figures/page57_img0.png)
...
![page58_img0.png](./figures/page58_img0.png)
...
![page59_img0.png](./figures/page59_img0.png)
...
![page60_img0.png](./figures/page60_img0.png)

![page60_img1.png](./figures/page60_img1.png)

![page60_img2.png](./figures/page60_img2.png)

![page60_img3.png](./figures/page60_img3.png)

![page60_img4.png](./figures/page60_img4.png)

![page60_img5.png](./figures/page60_img5.png)
...
![page61_img0.png](./figures/page61_img0.png)
...
![page62_img0.png](./figures/page62_img0.png)
...
![page64_img0.png](./figures/page64_img0.png)
